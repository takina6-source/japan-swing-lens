...
- Archive branch: `codex/phase2a-cutover`
...
4. `docs/PHASE2A_FORMING_MINT_GATE_DESIGN.md`
5. `docs/PHASE2A_FORMING_MINT_GATE_DESIGN_RESULT.md`
6. `docs/PHASE2A_FORMING_MINT_GATE_MIGRATION_ACTIVATION_GOAL.md`
